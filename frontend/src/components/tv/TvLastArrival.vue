  ...
  >
    ...
    <template v-if="arrival">
      ...
      >
        ...
        <div
          class="min-w-0 rounded-2xl bg-sky-50 p-4 text-center"
        >
          ...
          <p
            class="mt-2 text-3xl font-black text-sky-700"
          >
            {{ arrival.position ?? "—" }}
          </p>
        ...
        <div
          class="min-w-0 rounded-2xl bg-green-50 p-4 text-center"
        >
        ...
        <div
          class="min-w-0 rounded-2xl bg-slate-100 p-4 text-center"
        >
